    ...
    <section className="work-grid relative min-h-[calc(100vh-64px)]">
      <div className="mx-auto max-w-[1500px] px-5 py-7 sm:px-8 lg:py-10">
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_330px]">
          ...
          <aside className="rounded-3xl border border-white/10 bg-[#181b1d]/85 p-5 shadow-2xl shadow-black/20"><div className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[.22em] text-white/30"><Settings2 size={14}/> Tool specification</div><div className="mt-5 rounded-2xl border border-white/8 bg-[#101214] p-5"><div className="text-2xl font-black tracking-tight">{tool.short}</div><p className="mt-2 text-xs leading-5 text-white/40">{tool.description}</p><div className="mt-5 grid grid-cols-2 gap-2"><div className="rounded-xl bg-white/[.03] p-3"><div className="text-[8px] font-bold uppercase tracking-[.15em] text-white/25">Input</div><div className="mt-1 text-sm font-bold">{tool.from}</div></div><div className="rounded-xl bg-white/[.03] p-3"><div className="text-[8px] font-bold uppercase tracking-[.15em] text-white/25">Output</div><div className="mt-1 text-sm font-bold">{tool.to}</div></div></div></div><div className="mt-4 space-y-2 text-[10px] text-white/40"><div className="flex items-center gap-2"><Zap size={13} className="text-[#e0a14a]"/> Hardware-free browser processing</div><div className="flex items-center gap-2"><ShieldCheck size={13} className="text-[#78b98b]"/> No file upload required</div><div className="flex items-center gap-2"><Minimize2 size={13} className="text-white/50"/> Output generated locally</div></div><a href="https://www.techcraftsolution.com" target="_blank" rel="noopener noreferrer" className="mt-6 block text-left text-[10px] font-semibold tracking-[.08em] text-white/35 transition hover:text-white/60">Made with <span className="text-[#38bdf8]">♥</span> by <span className="text-[#38bdf8] underline underline-offset-2">TechCraft</span></a></aside>
        </div>
      </div>
    </section>
